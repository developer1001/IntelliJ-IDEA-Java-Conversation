...
1、 负责平台技术架构选型、设计和优化，实现高并发、高可用、高稳定性。

2、 参与项目的需求分析、架构设计、技术选型、技术难题攻关、核心功能设计和实现、性能调优等工作。

3、 根据业务及技术发展持续优化架构，做前瞻性的技术分析、研究及应用。

任职资格：

4、 全日制统招本科及以上学历，计算机、软件工程等相关专业。

5、 具有6年以上扎实的JAVA开发经验，JAVA基础扎实，熟悉JVM原理，熟悉Java EE相关技术，对Spring等开源框架有深入理解。

6、 深刻理解微服务架构思想，具有大中型分布式系统架构设计、开发、运营维护经验。

7、 熟悉分布式、缓存、消息、搜索等机制，能对常用开源技术进行合理应用及解决问题，有较强的分析设计能力和方案整合能力。

8、 熟悉Linux 操作系统，熟悉Tomcat、Apache、Nginx、MySQL、Redis、MongoDB等常用开源软件的安装配置及性能调优。

9、 思路清晰，善于思考，能独立分析和解决问题,责任心强，具备良好的团队合作精神和承受压力的能力。
